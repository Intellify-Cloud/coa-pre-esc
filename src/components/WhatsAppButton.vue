<template>
  <a
    ...
    class="whatsapp-button fixed bottom-6 right-6 z-50 relative group pointer-events-auto grid place-items-center w-14 h-14 shadow-lg"
  >
...
<script setup lang="ts">
  ...
  const whatsappNumber = siteText['contact-bar'].phone.replace(/\D/g, '').replace(/^0/, '27')
</script>
